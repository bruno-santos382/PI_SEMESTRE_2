...
$template = array(
    'titulo' => 'Limpeza &mdash; GM Supermercado',
...
<div class="container my-5">
    <h2 class="text-center mb-4">Setor de Limpeza</h2>

    <?php 
        // Categorias da página de Limpeza
        foreach ($categoria->listarPorPagina('limpeza') as $item) {
