...
$template = array(
    'titulo' => 'Padaria &mdash; GM Supermercado',
...
<div class="container my-5">
    <h2 class="text-center mb-4">Setor de Padaria</h2>

    <?php 
        // Categorias da página de Padaria
        foreach ($categoria->listarPorPagina('padaria') as $item) {
